...
namespace GeradorTestes.Cadastros.Disciplinas
{
    ...
    {
        CadastroDisciplinaDialogs _cadastroDisciplinaDialog;
        DisciplinaServico _disciplinaServico = new DisciplinaServico();
        ListaDisciplinaUserControl _disciplinaUserControl;

        public override void Adicionar()
        {
            _cadastroDisciplinaDialog = new CadastroDisciplinaDialogs(_disciplinaServico, "Cadastro de disciplinas", null);
        ...
        public override void Editar()
        {
            ...
            {
                _cadastroDisciplinaDialog = new CadastroDisciplinaDialogs(_disciplinaServico, "Edição de disciplina", _disciplinaUserControl.GetSelect());
                _cadastroDisciplinaDialog.ShowDialog();
                AtualizarLista();
            }
            else
